...
def get_link_prediction_args(is_evaluation: bool = False):
    ...
    parser.add_argument('--model_name', type=str, default='DyRep', help='name of the model, note that EdgeBank is only applicable for evaluation',
    ...
    parser.add_argument('--load_best_configs', type=str, default="True", help='whether to load the best configurations')
